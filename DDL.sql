...
DROP TABLE TB_ITENS CASCADE CONSTRAINTS; 
DROP TABLE TB_LOGS CASCADE CONSTRAINTS; 
DROP TABLE TB_SERVICOS CASCADE CONSTRAINTS; 
DROP TABLE TB_TRANSPORTADORES CASCADE CONSTRAINTS; 

DROP SEQUENCE SEQ_TB_CLIENTES;
DROP SEQUENCE SEQ_TB_ENDERECOS;
DROP SEQUENCE SEQ_TB_ITENS;
DROP SEQUENCE SEQ_TB_LOGS;
DROP SEQUENCE SEQ_TB_SERVICOS;
DROP SEQUENCE SEQ_TB_TRANSPORTADORES;
