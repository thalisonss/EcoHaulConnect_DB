...
BEGIN
    IF INSERTING THEN
        v_tp_exec := 'INSERT';
        v_tx_valorantigo := NULL;
        v_tx_valornovo := :NEW.id_servico || ',' || :NEW.nr_valor || ',' || :NEW.cd_confirmacao || ',' || TO_CHAR(:NEW.dt_agendamento, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_criacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_atualizacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_vencimento, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_aceitacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_cancelamento, 'YYYY-MM-DD') || ',' || :NEW.st_conclusao || ',' || :NEW.st_ativo || ',' || :NEW.id_endereco || ',' || :NEW.id_transportador || ',' || :NEW.id_cliente;
    ELSIF UPDATING THEN
        v_tp_exec := 'UPDATE';
        v_tx_valorantigo := :OLD.id_servico || ',' || :OLD.nr_valor || ',' || :OLD.cd_confirmacao || ',' || TO_CHAR(:OLD.dt_agendamento, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_criacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_atualizacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_vencimento, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_aceitacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_cancelamento, 'YYYY-MM-DD') || ',' || :OLD.st_conclusao || ',' || :OLD.st_ativo || ',' || :OLD.id_endereco || ',' || :OLD.id_transportador || ',' || :OLD.id_cliente;
        v_tx_valornovo := :NEW.id_servico || ',' || :NEW.nr_valor || ',' || :NEW.cd_confirmacao || ',' || TO_CHAR(:NEW.dt_agendamento, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_criacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_atualizacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_vencimento, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_aceitacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:NEW.dt_cancelamento, 'YYYY-MM-DD') || ',' || :NEW.st_conclusao || ',' || :NEW.st_ativo || ',' || :NEW.id_endereco || ',' || :NEW.id_transportador || ',' || :NEW.id_cliente;
    ELSE
        v_tp_exec := 'DELETE';
        v_tx_valorantigo := :OLD.id_servico || ',' || :OLD.nr_valor || ',' || :OLD.cd_confirmacao || ',' || TO_CHAR(:OLD.dt_agendamento, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_criacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_atualizacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_vencimento, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_aceitacao, 'YYYY-MM-DD') || ',' || TO_CHAR(:OLD.dt_cancelamento, 'YYYY-MM-DD') || ',' || :OLD.st_conclusao || ',' || :OLD.st_ativo || ',' || :OLD.id_endereco || ',' || :OLD.id_transportador || ',' || :OLD.id_cliente;
