...
VALUES (seq_tb_itens.NEXTVAL, 'Eletronico', 5.5, 22, 19.5, 0.5, 'Placa Mãe Centrium Micro ATX LGA 1151 DDR4 C2018', 1);

INSERT INTO tb_itens (id_item, tp_item, nr_altura, nr_comprimento, nr_largura, nr_peso, ds_descricao, id_servico)
VALUES (seq_tb_itens.NEXTVAL, 'Eletronico', 28, 11.67, 4.4, 0.4, 'Zotac GTX 1650', 1);

INSERT INTO tb_itens (id_item, tp_item, nr_altura, nr_comprimento, nr_largura, nr_peso, ds_descricao, id_servico)
VALUES (seq_tb_itens.NEXTVAL, 'Moveis', 78, 140, 240, 35, 'Sofá 2 Lugares Europa Linho Bege ADJ Decor', 2);

INSERT INTO tb_itens (id_item, tp_item, nr_altura, nr_comprimento, nr_largura, nr_peso, ds_descricao, id_servico)
VALUES (seq_tb_itens.NEXTVAL, 'Moveis', 200, 180, 46.5, 30, 'Guarda Roupa Casal 6 Portas 3 Gavetas Toledo MX Móveis', 3);

INSERT INTO tb_itens (id_item, tp_item, nr_altura, nr_comprimento, nr_largura, nr_peso, ds_descricao, id_servico)
VALUES (seq_tb_itens.NEXTVAL, 'Moveis', 90, 90, 40, 20, 'Cômoda Sapateira 1 Porta 5 Gavetas Zurique Evidência Móveis', 3);
